  ...
  <div className="mt-8">
    ...
    <div className="flex flex-wrap gap-4">
      ...
      <button
        ...
        className="bg-red-600 hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed text-white px-8 py-3
    ...
    {bulkGenerating && (
      ...
      <div className="mt-6">
        ...
        <div className="flex justify-between mb-2 font-semibold">
          ...
          <span>
            {completed}/{totalCustomers} Customers
          </span>
...
>   data-pdf-bill="true"
  ...
  >
    ...
    <button
      ...
      className="bg-emerald-700 hover:bg-emerald-800 disabled:opacity-60 disabled:cursor-not-allowed text-white px-8 py-3
