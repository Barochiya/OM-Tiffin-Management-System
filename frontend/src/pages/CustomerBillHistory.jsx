...
const CustomerBillHistory = () => {
  ...
  const loadBills = useCallback(async ({ showLoader = false } = {}) => {
    try {
      if (showLoader) {
        setRefreshing(true);
      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-[76px] flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                type="button"
                onClick={() => loadBills({ showLoader: true })}
                disabled={refreshing}
              ...
              {bills.map((bill) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full mt-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 text-sm font-bold transition"
                  >
                    View Bill
                  </button>
                </div>
                      ...
                      >
                        ...
                        <td className="px-5 py-4 text-center">
                          <button
                            type="button"
                            onClick={() => viewBill(bill._id)}
                            className="rounded-xl bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 text-sm font-bold transition"
                          >
                            View Bill
                          </button>
                        </td>
